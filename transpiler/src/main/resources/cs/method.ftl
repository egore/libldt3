...
${method.visibility!}<#if method.static> static</#if> <@converttype type=method.type/> ${method.simpleName}(<#list method.parameters as parameter><@converttype type=parameter.type/> ${parameter.simpleName}<#sep>, </#list>)
</#macro>
